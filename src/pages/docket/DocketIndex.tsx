...
function buildJSON(): string {
  return JSON.stringify({
    meta: {
      ...
      source: "Margin of Error (margin-of-error.arinjain-mail.workers.dev/docket)",
...
<body>
  ...
  <p class="meta">
    Source: <a href="https://margin-of-error.arinjain-mail.workers.dev/docket" target="_blank">Margin of Error / The Docket</a>
