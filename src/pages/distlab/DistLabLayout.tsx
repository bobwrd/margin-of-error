      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-4">
          <div className="flex items-center gap-4 shrink-0">
            <Link to="/" className="text-xs font-mono tracking-wider opacity-40 hover:opacity-70 transition-opacity" style={{ color: "var(--dl-muted)" }}>
              ← MOE
            </Link>
            <Link to="/lab" className="font-semibold tracking-tight text-sm flex items-center gap-2" style={{ color: "var(--dl-accent)" }}>
