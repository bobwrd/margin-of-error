...
export default function ArenaMethods() {
  useEffect(() => {
    document.title = "Technical Note — The Arena · Margin of Error";
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-14">
      ...
      <div className="mt-12 pt-6 border-t text-xs font-mono" style={{ borderColor: "var(--arena-border)", color: "var(--arena-muted)" }}>
        <p>THE ARENA · Margin of Error · Technical Note</p>
        <p className="mt-1">
        ...
        <Link to="/arena" className="mt-3 inline-block hover:opacity-70 transition-opacity" style={{ color: "var(--arena-accent)" }}>
          ← Return to The Arena
        </Link>
      </div>
    </div>
