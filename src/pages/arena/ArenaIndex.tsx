...
export default function ArenaIndex() {
  useEffect(() => {
    document.title = "Margin of Error — The Arena: Competition and Efficiency";
  }, []);
  ...
  return (
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pb-16 pt-4 border-t" style={{ borderColor: "var(--arena-border)" }}>
        <p className="text-xs mb-3" style={{ color: "var(--arena-muted)" }}>Related work on Margin of Error:</p>
        <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm">
          <a href="/observatory" className="hover:underline" style={{ color: "var(--arena-accent)" }}>
            The Observatory — AI, productivity and prices →
          </a>
          <a href="/verdict" className="hover:underline" style={{ color: "var(--arena-accent)" }}>
