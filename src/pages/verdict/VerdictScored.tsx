...
export default function VerdictScored() {
  ...
  return (
    <div>
      ...
      >
        <Link to="/verdict/1" className="hover:underline" style={{ color: "var(--verdict-accent)" }}>
          Full case record with data →
        </Link>
        <Link to="/verdict/about" className="hover:underline" style={{ color: "var(--verdict-accent)" }}>
          Full methodology →
        </Link>
        <Link to="/verdict" className="hover:underline" style={{ color: "var(--verdict-accent)" }}>
          ← All cases
        </Link>
      </div>
    </div>
